...
@Component({
  ...
  templateUrl: './inscription-dialog-espaces-admin.component.html',
  styleUrls: ['./inscription-dialog-espaces-admin.component.scss']
})
export class InscriptionDialogEspacesAdminComponent {
